...
<nav id="detailMenu">
   ...
   <div class="containers">
         ...
         <ul>
            <li><label class="label">아이디 <span>*</span></label><input type="text" name="userid" id="userid" value="${vo.userid}" class="inputBox" readonly/>
                  
                  <div class="id1"></div>
                  
                  </li>
            <li><label class="label">비밀번호 <span>*</span></label><input type="password" name="userpwd" id="userpwd" class="inputBox inputBoxLong" placeholder="비밀번호를 입력해주세요"/>
               <div class="pw1"></div></li>
            <li><label class="label">비밀번호확인 <span>*</span></label><input type="password" name="userpwdchk" id="userpwdchk" class="inputBox inputBoxLong" placeholder="비밀번호를 입력해주세요"/>
               <div class="pw2"></div></li>
                  
            <li><label class="label">이름 <span>*</span></label><input type="text" name="username" value="${vo.username}" id="username" class="inputBox" readonly/>
                  <input type="radio" name="gender" value="남" checked="checked"/>남
                  <input type="radio" name="gender" value="여"/> 여</li>
            <li>
               <label class="label">생년월일</label>
               <input name="publeYear" autocomplete="off" readonly="readonly" placeholder="생년월일을 입력해주세요">
               
            </li>
            <li><label class="label">전화번호</label>
               
               <input type="text" name="tel1" id="tel1" class="tel" value="${vo.tel1}" maxlength='3' onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/> <!-- 숫자외 다른문자 입력시 자동으로 지워짐 -->
               <input type="text" name="tel2" id="tel2" class="tel" value="${vo.tel2}"maxlength='4' onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
               <input type="text" name="tel3" id="tel3" class="tel" value="${vo.tel3}" maxlength='4' onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
               
            </li>
            
            <li><label class="label">우편번호</label><input type="text" name="addr1" value="${vo.addr1}" id="addr1" class="inputBox"/>
            <input type="button" onclick="sample6_execDaumPostcode()" id="zipSearch" value="우편번호찾기"/>
            </li>
            <li><label class="label">주소</label><input type="text" name="addr2" id="addr2" value="${vo.addr2}" class="inputBox inputBoxLong"/></li>
            <li><label class="label">상세주소</label><input type="text" name="addr3" id="addr3"value="${vo.addr3}" class="inputBox inputBoxLong"/></li>
            <li><label class="label">참고항목</label><input type="text" name="addr4" id="addr4" value="${vo.addr4}" class="inputBox inputBoxLong"></li>
            <li style="height: 40px;"><label class="label">이메일</label><input type="text" value="${vo.emailid }"  id="emailid" name="emailid"  class="inputBox inputBoxShort"/>@
            <input type="text" name="domain" id="domain" value="${vo.domain}"class="inputBox inputBoxShort">
    ...
    margin-bottom: 20px;" id="email"type="text" name="emailCheck"  class="inputBox inputBoxLong" placeholder="인증번호 입력"><br/><div class="mail"></div></li>
            <li id="joinbtn"><input type="submit" value="수정하기"class="join" /></li>
     	 </ul>
      </form>
