...
.custom-shape-divider-top-1634813937 {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
.custom-shape-divider-top-1634813937 svg {
    position: relative;
    display: block;
...
.custom-shape-divider-top-1634813937 .shape-fill {
    fill: #FFFFFF;
}
</style>
<script>
...
<header>
	<div id="head_img"></div>
	<div id="headerText">MD PRODUCT</div>
</header>
...
<div class="custom-shape-divider-top-1634813937">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
