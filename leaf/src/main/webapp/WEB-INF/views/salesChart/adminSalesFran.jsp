...
/* 사이드 메뉴------------------------------------------------------------------------------------ */
	...
	.sideChartWriteName{position:absolute; width:200px; font-size:1.1rem; top:220px; left:-10px; color:#FF9999; font-weight:600; text-align:center;}
...
/*  바디부 -------------------------------------*/
	...
	.salesRankList>li:nth-child(4n+3){width:20%; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;}
